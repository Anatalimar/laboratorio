...
-- Table `db_gesi`.`calha`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_gesi`.`calha` (
  `cal_codigo` INT NOT NULL AUTO_INCREMENT,
  `cal_descricao` VARCHAR(45) NULL,
  PRIMARY KEY (`cal_codigo`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `db_gesi`.`municipio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_gesi`.`municipio` (
  `mun_codigo` INT NOT NULL AUTO_INCREMENT,
  `mun_descricao` VARCHAR(45) NOT NULL,
  `mun_calha` INT NOT NULL,
  PRIMARY KEY (`mun_codigo`),
    FOREIGN KEY (`mun_calha`)
    REFERENCES `db_gesi`.`calha` (`cal_codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_gesi`.`unidade` (
  ...
  `und_municipio` INT NOT NULL,
  PRIMARY KEY (`und_codigo`),
    FOREIGN KEY (`und_municipio`)
    REFERENCES `db_gesi`.`municipio` (`mun_codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
