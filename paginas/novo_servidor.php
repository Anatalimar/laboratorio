...
<body>
  <header>
    <div>
      <h2 class="Cabecalho">CADASTRO DE NOVO SERVIDOR</h2>
    </div>
  </header>
    ...
    <form id="form-cadastro" action="validacao.php">
      ...
      <div class="row justify-content align-items-center g-2">
        ...
        <div class="col-3">
          ...
          <input type="text" class="form-control" id="cpf" name="cpf" placeholder="EX: 00011122233" maxlength="14"
            required>
        </div>
        <div class="col">
          <label for="nome" class="form-label">Nome Completo</label>
          <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome completo do servidor"
      ...
      <div class="row justify-content align-items-center g-2">
        ...
        <div class="col-3">
          ...
          <input type="tel" class="form-control" id="fone_pessoal" name="fone_pessoal" placeholder="EX: (XX) XXXXX-XXXX"
        ...
        <div class="col-3">
          ...
          <input type="tel" class="form-control" id="fone_corp" name="fone_corp" placeholder="EX: (XX) XXXXX-XXXX"
            maxlength="15" required oninput="this.value = formatarTelefone(this.value)">
        </div>
      </div>
      <div class="mb-3"></div>
